...
<Tabs>
  ...
  ```code
  $ tctl lock --role=contractor --message="All contractor access is disabled for 10h." --ttl=24h
  # Created a lock with name "dc7cee9d-fe5e-4534-a90d-db770f0234a1".
  ```
  </TabItem>
  ...
  ```code
  $ tctl lock --mfa-device=d6c06a18-e147-4232-9dfe-6f83a28d5850 --message="All contractor access is disabled for 10h." --ttl=24h
