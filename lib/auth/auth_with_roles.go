...
func (a *ServerWithRoles) DeleteDatabaseService(ctx context.Context, name string) error {
	if err := a.ScopedServerWithRoles().agentOwnedResourceAction(ctx, name, types.RoleDatabase); err != nil {
...
func (a *ServerWithRoles) DeleteWindowsDesktopService(ctx context.Context, name string) error {
	if err := a.ScopedServerWithRoles().agentOwnedResourceAction(ctx, name, types.RoleWindowsDesktop); err != nil {
