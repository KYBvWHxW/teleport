...
func TestAccessListParserScopedDelete(t *testing.T) {
	...
	parser := newAccessListParser(types.WatchKind{Kind: types.KindAccessList})
...
func TestAccessListMemberParserScopedDelete(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			parser := newAccessListMemberParser(types.WatchKind{Kind: types.KindAccessListMember})
			require.True(t, parser.match(key))
...
func TestAccessListReviewParserScopedDelete(t *testing.T) {
	...
	parser := newAccessListReviewParser(types.WatchKind{Kind: types.KindAccessListReview})
	require.True(t, parser.match(key))
