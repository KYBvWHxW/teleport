...
- [ ] Access Requests
  ...
  - [ ] Resource-Scoped Constraints
    ...
    - [ ] Mixed-version: with an older Auth that does not populate the granted/requestable split, `tsh request search` still lists resources (all principals shown as requestable) and constrained `request create` still works.
